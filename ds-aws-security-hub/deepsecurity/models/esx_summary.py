...
class ESXSummary(object):
    ...
    def __init__(self, manufacturer=None, model=None, processors=None, processor_type=None, number_of_nics=None, state=None, virtual_machines=None, custom_attributes=None, tpm_enabled=None, tpm_alerts_enabled=None, v_motion_enabled=None, tpm_has_data=None, tpm_last_checked=None):  # noqa: E501
